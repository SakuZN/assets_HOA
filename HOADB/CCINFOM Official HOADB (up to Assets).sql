...
CREATE TABLE IF NOT EXISTS `HOADB`.`provinces` (
  ...
  INDEX `FKAMELIA01_idx` (`region` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`zipcodes` (
  ...
  INDEX `FKNORM06_idx` (`province` ASC),
  CONSTRAINT `FKNORM06`
...
CREATE TABLE IF NOT EXISTS `HOADB`.`hoa` (
  ...
  INDEX `FK003_idx` (`req_collectionday` ASC),
  INDEX `FKNORM08_idx` (`ofcaddr_barangay` ASC, `ofcaddr_city` ASC, `ofcaddr_province` ASC),
  CONSTRAINT `FK003`
...
CREATE TABLE IF NOT EXISTS `HOADB`.`people` (
  ...
  UNIQUE INDEX `picturefile_UNIQUE` (`picturefile` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `HOADB`.`homeowner` (
  ...
  PRIMARY KEY (`ho_id`),
  UNIQUE INDEX `other_email_UNIQUE` (`other_email` ASC),
  UNIQUE INDEX `other_mobile_UNIQUE` (`other_mobile` ASC),
  INDEX `FKNORM03_idx` (`other_barangay` ASC, `other_city` ASC, `other_province` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`properties` (
  ...
  INDEX `FKBENSON03_idx` (`hoa_name` ASC),
  INDEX `FKBENSON04_idx` (`ho_id` ASC),
  INDEX `FKJASON05_idx` (`household_id` ASC),
  UNIQUE INDEX `household_id_UNIQUE` (`household_id` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`residents` (
  ...
  INDEX `FKGABRIEL01_idx` (`household_id` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HOADB`.`outsiders` ;

CREATE TABLE IF NOT EXISTS `HOADB`.`outsiders` (
...
CREATE TABLE IF NOT EXISTS `HOADB`.`elections` (
  ...
  INDEX `FKNORM20_idx` (`outsider_wname` ASC),
  CONSTRAINT `FKNORM20`
    FOREIGN KEY (`outsider_wname`)
    REFERENCES `HOADB`.`outsiders` (`name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `HOADB`.`officer` (
  ...
  INDEX `FKBENSON01_idx` (`position` ASC),
  PRIMARY KEY (`ho_id`, `position`, `election_date`),
  INDEX `FKNORM01_idx` (`election_date` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`resident_idcards` (
  ...
  `position` VARCHAR(45) NOT NULL,
  `election_date` DATE NOT NULL,
  UNIQUE INDEX `ORnum_UNIQUE` (`ornum` ASC),
  PRIMARY KEY (`card_number`),
  INDEX `FKGABRIEL02_idx` (`resident_id` ASC),
  INDEX `FKSENATOR01_idx` (`ofcr_hoid` ASC, `position` ASC, `election_date` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`asset_transactions` (
  ...
  INDEX `FKLANZ15_idx` (`trans_hoid` ASC, `trans_position` ASC, `trans_electiondate` ASC),
  INDEX `FKLANZ16_idx` (`approval_hoid` ASC, `approval_position` ASC, `approval_electiondate` ASC),
  INDEX `FKLANZ17_idx` (`ornum` ASC),
  UNIQUE INDEX `ornum_UNIQUE` (`ornum` ASC),
  CONSTRAINT `FKLANZ01`
...
CREATE TABLE IF NOT EXISTS `HOADB`.`asset_transfer` (
  ...
  INDEX `FKNORM35_idx` (`completename` ASC),
...
CREATE TABLE IF NOT EXISTS `HOADB`.`asset_rentals` (
  ...
  INDEX `FKTYE10_idx` (`accept_hoid` ASC, `accept_position` ASC, `accept_electiondate` ASC),
  INDEX `FKTYE63_idx` (`resident_id` ASC),
  CONSTRAINT `FKTYE10`
...
CREATE TABLE IF NOT EXISTS `HOADB`.`asset_donations` (
  ...
  INDEX `FKTYE40_idx` (`accept_hoid` ASC, `accept_position` ASC, `accept_electiondate` ASC),
  INDEX `FKTYE68_idx` (`approval_hoid` ASC, `approval_position` ASC, `approval_electiondate` ASC),
  INDEX `FKNORM30_idx` (`donor_completename` ASC),
  CONSTRAINT `FKTYE40`
    FOREIGN KEY (`accept_hoid` , `accept_position` , `accept_electiondate`)
    REFERENCES `HOADB`.`officer` (`ho_id` , `position` , `election_date`)
    ON DELETE NO ACTION
...
CREATE TABLE IF NOT EXISTS `HOADB`.`donated_assets` (
  ...
  INDEX `FKTYE30_idx` (`asset_id` ASC),
  CONSTRAINT `FKTYE30`
    FOREIGN KEY (`asset_id`)
    REFERENCES `HOADB`.`assets` (`asset_id`)
    ON DELETE NO ACTION
...
START TRANSACTION;
USE `HOADB`;
INSERT INTO `HOADB`.`outsiders` (`name`, `mobileno`) VALUES ('Jose Ignacio', 09817776666);
INSERT INTO `HOADB`.`outsiders` (`name`, `mobileno`) VALUES ('Maria Estrella', 09816667777);
INSERT INTO `HOADB`.`outsiders` (`name`, `mobileno`) VALUES ('Juan Estanislao', 09823335454);
INSERT INTO `HOADB`.`outsiders` (`name`, `mobileno`) VALUES ('Kyle Rosalita', 09285443322);
...
START TRANSACTION;
USE `HOADB`;
INSERT INTO `HOADB`.`asset_transfer` (`asset_id`, `schedule_date`, `act_date`, `source_lattitude`, `source_longitude`, `dest_latittude`, `dest_longitude`, `transfer_cost`, `status`, `completename`) VALUES (5005, '2022-12-21', '2022-12-23', 100.430, 100.530, 150.550, 150.560, 50, 'C', 'Juan Estanislao');
INSERT INTO `HOADB`.`asset_transfer` (`asset_id`, `schedule_date`, `act_date`, `source_lattitude`, `source_longitude`, `dest_latittude`, `dest_longitude`, `transfer_cost`, `status`, `completename`) VALUES (5005, '2022-12-23', '2022-12-23', 243.550, 254.223, 212.445, 212.422, 100, 'C', 'Kyle Rosalita');
INSERT INTO `HOADB`.`asset_transfer` (`asset_id`, `schedule_date`, `act_date`, `source_lattitude`, `source_longitude`, `dest_latittude`, `dest_longitude`, `transfer_cost`, `status`, `completename`) VALUES (5007, '2022-12-23', '2022-12-23', 423.212, 353.234, 255.256, 123.532, 100, 'C', 'Kyle Rosalita');
...
START TRANSACTION;
USE `HOADB`;
INSERT INTO `HOADB`.`asset_rentals` (`asset_id`, `rental_date`, `reservation_date`, `resident_id`, `rental_amount`, `discount`, `status`, `inspection_details`, `assessed_value`, `accept_hoid`, `accept_position`, `accept_electiondate`, `return_date`) VALUES (5008, '2022-12-23', '2022-12-20', 9016, 50, 0, 'N', 'All returned OK', 0, 9009, 'Secretary', '2022-12-01', '2022-12-23');
INSERT INTO `HOADB`.`asset_rentals` (`asset_id`, `rental_date`, `reservation_date`, `resident_id`, `rental_amount`, `discount`, `status`, `inspection_details`, `assessed_value`, `accept_hoid`, `accept_position`, `accept_electiondate`, `return_date`) VALUES (5010, '2022-12-23', '2022-12-20', 9017, 50, 0, 'N', 'All returned OK', 0, 9010, 'Treasurer', '2022-12-01', '2022-12-25');
INSERT INTO `HOADB`.`asset_rentals` (`asset_id`, `rental_date`, `reservation_date`, `resident_id`, `rental_amount`, `discount`, `status`, `inspection_details`, `assessed_value`, `accept_hoid`, `accept_position`, `accept_electiondate`, `return_date`) VALUES (5008, '2022-12-24', '2022-12-20', 9018, 50, 0, 'N', 'Some Damage', 500, 9010, 'Treasurer', '2022-12-01', '2022-12-25');
